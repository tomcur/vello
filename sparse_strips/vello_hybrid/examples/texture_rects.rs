...
use vello_hybrid::{
    RenderSize, RenderTargetConfig, Resources, SampleRect, Scene, TextureBindings, TextureId,
};
...
async fn run() {
    ...
    let src_full = RectU16::new(0, 0, atlas_width as u16, atlas_height as u16);
    let sprite_cells = [
        RectU16::new(0, 3, 62, 61),
        RectU16::new(62, 3, 124, 61),
        RectU16::new(124, 3, 185, 61),
        RectU16::new(185, 3, 250, 61),
    ];
    ...
    scene.draw_texture_rects(
        ...
        sprite_cells
            ...
            .copied()
            .zip([30., 98., 166., 234.])
            .map(|(source_region, x)| SampleRect {
                source_region,
    ...
    scene.draw_texture_rects(
        ...
        ImageQuality::Medium,
        [SampleRect {
            source_region: src_full,
            transform: Affine::scale(148. / f64::from(src_full.width()))
                .then_translate((336., 52.).into()),
        }],
    );
